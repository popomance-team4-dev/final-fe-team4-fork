...
import { TableFooter } from '@/components/custom/tables/project/common/TableFooter';
import { TableHeader } from '@/components/custom/tables/project/common/TableHeader';
...
import { TTSTableGridView } from './TTSTableGridView';

interface TTSTableContentsProps {
  items: TableItem[];
...
export const TTSTableContents: React.FC<TTSTableContentsProps> = ({
  items,
  onSelectionChange,
  onTextChange,
  onDelete,
